...
public class RootIsolationTests
{
    ...
    public void TestRootContainedInInterval()
    {
        ...
        PolynomialDouble poly = new PolynomialDouble(new double[] { -3, 1 }); // Represents x - 3

        // Create an interval that includes the root, e.g., [2, 4]
        IntervalDouble interval = new IntervalDouble(2, 4);
        ...
        Assert.True(containsRoot, $"IntervalDouble {interval} does not contain the known root: {knownRoot}.");
    }
    ...
    public void TestNoRoots()
    {
        ...
        var poly = new PolynomialDouble([1, 0, 1]);
    ...
    public void TestSingleRoot()
    {
        ...
        var poly = new PolynomialDouble([1, -2, 1]);
        var intervals = poly.IsolatePositiveRootIntervalsContinuedFractions();
        AssertExtensionsDouble.AssertIntervalsContainRoots(intervals, [1]);
    }
    ...
    public void TestMultipleRoots()
    {
        ...
        var poly = new PolynomialDouble([-6, 11, -6, 1]);
        var intervals = poly.IsolatePositiveRootIntervalsContinuedFractions();
        AssertExtensionsDouble.AssertIntervalsContainRoots(intervals, [1, 2, 3]);
    }
    ...
    public void TestRootAtZero()
    {
        ...
        var poly = new PolynomialDouble([0, 0, 1]);
        var intervals = poly.IsolatePositiveRootIntervalsContinuedFractions();
        ...
        AssertExtensionsDouble.AssertIntervalsContainRoots(intervals, [0]);
    }
    ...
    public void TestCloseRoots()
    {
        ...
        var poly = new PolynomialDouble([0.000002f, -0.003f, 1]);
        var intervals = poly.IsolatePositiveRootIntervalsContinuedFractions();
        ...
        List<double> expectedRoots = [0.001f, 0.002f];
        AssertExtensionsDouble.AssertIntervalsContainRoots(intervals, expectedRoots);
    }
}
